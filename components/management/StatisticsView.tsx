...
import { Trophy, Crown, Flame, Target, Medal, BarChart3, Zap, Package } from 'lucide-react';
    ...
    return (
        <div className="p-4 space-y-4 animate-fadeIn pb-24">
                        ...
                        return (
                            <div
                                ...
                                className={`p-4 transition-all ${isPlayer
                                    ? 'bg-gradient-to-r from-emerald-900/40 to-transparent border-l-4 border-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.1)]'
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="bg-slate-900/60 border border-slate-700/50 rounded-xl p-3 col-span-2">
